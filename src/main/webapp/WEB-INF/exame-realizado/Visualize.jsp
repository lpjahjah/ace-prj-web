...
<main role="main" class="container my-4">
	...
	<div class="d-flex justify-content-between">
		<h2>Visualização de Exame Realizado</h2>
		<div class="d-flex">
	...
	<s:form class="mt-3">
		...
		<div class="mb-3">
		    <label for="cdExameRealizado" class="form-label">Código do Exame Realizado</label>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a href="<s:url action='delete' ><s:param name="toDelete" value="%{exameRealizado.cdExameRealizado}" /></s:url>" class="btn btn-danger">Confirmar Exclusão</a>
				</div>
			</div>
		</div>
	</div>
